      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="mb-6">
          ...
          <p className="text-slate-500 text-sm mt-1">
            Find plumbers, electricians, tutors and other verified local workers near you. Filter by
            trade, set your radius, and book help for your needs.
          </p>
          <p className="text-sm text-slate-500 mt-3">
            Need help choosing a service?{" "}
            <Link href="/how-it-works" className="font-medium text-[#2E6E8E] hover:underline">
              Learn how Getworkfy works
            </Link>
            .
          </p>
        ...
        {loading ? (
          ...
          >
            ...
            <Link href="/workers" className="inline-flex mt-5 text-sm font-medium text-[#101B2B] underline underline-offset-4 hover:text-[#2E6E8E]">
              View all workers
            </Link>
          </motion.div>
        ) : (
